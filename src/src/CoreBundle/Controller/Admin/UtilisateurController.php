...
class UtilisateurController extends AbstractControllerService
{
    ...
    public function deleteAction(Request $request)
    {
        ...
        $this->initData('index');
        $this->get('core.utilisateur_manager')->archiveOrNot($request->query->get('itemDelete'), $request->query->get('isArchived'));
    ...
    public function form_exec_editAction(Request $request)
    {
        ...
        if ($this->formEdit->isSubmitted() && $this->formEdit->isValid()) {
            if ($request->request->get('formAction') == 'edit') {
                ...
                $this->googleActions($request);
                $this->odigoActions($request);
                $this->actionDirectoryActions($request);
                $this->salesforceActions($request);
            }
        }
